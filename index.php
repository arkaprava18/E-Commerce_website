<!-- AUTO RELOAD FOR BROWSERS -->
<!-- <?php
// Set the refresh interval (in seconds)
$refreshInterval = 3; // 10 seconds
...
<body>
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="card">
                            <img src="./image/dairy milk.png" class="card-img-top" alt="...">
                            <div class="card-body">
  ...
  <P>All right reserved &copy;- Designed by khanam-2022
</P>
</div>
    </div> -->
